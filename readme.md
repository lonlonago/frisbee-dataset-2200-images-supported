# Frisbee dataset 2200 images supported

# Body

Frisbee dataset， 2200 images, support YOLO format, clear images, complete annotations, suitable for target detection and computer vision related projects, ready to use, worry-free

Please send the download link for the , and non-refundable
